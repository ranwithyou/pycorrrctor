...
from pycorrector1.deepcontext.data_reader import write_config
from pycorrector1.deepcontext.model import Context2vec
from pycorrector1.deepcontext.dataset import Dataset
...
def train(train_path,
    ...
    print('vocab_2_ids_size:', len(dataset.vocab_2_ids))
    ...
    for epoch in range(epochs):
        ...
        if is_best:
            ...
            print('epoch:{}, save new deepcontext model:{}'.format(epoch + 1, model_dir))
